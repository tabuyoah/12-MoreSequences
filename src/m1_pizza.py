...
def run_test_pizza():
    ...
    # -------------------------------------------------------------------------
    title = '200 slices, thin black lines on a yellow circle.'
    window = rg.RoseWindow(400, 400, title)
    circle = rg.Circle(rg.Point(200, 200), 150)
...
def run_test_polygon():
    ...
    # -------------------------------------------------------------------------
    title = 'POLYGON tests 3: 4 segments with black lines in a lime green circle'
    window = rg.RoseWindow(400, 400, title)
...
def run_test_fancy_polygon():
    ...
    # -------------------------------------------------------------------------
    title = 'FANCY POLYGON test 4: 300 segments, hops of length 61'
    window = rg.RoseWindow(400, 400, title)
    circle = rg.Circle(rg.Point(200, 200), 150)
    circle.fill_color = 'gold'
    fancy_polygon(window, circle, 300, 61, 'red', 1)
    window.close_on_mouse_click()
